...
export default function AdminJornadasPage() {
  ...
  async function handleToggleMatchdayCounts(number: number, currentCounts: boolean) {
  ...
  async function handleToggleMatchCounts(matchId: number, currentCounts: boolean) {
