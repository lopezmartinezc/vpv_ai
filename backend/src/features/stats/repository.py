    ...
    async def get_player_stats(
        ...
        stmt = (
            select(
                ...
                # Average over numeric ratings only ("1"…"4" plus any
                # decimal Liga rows like "2.5"). "SC" and "-" stay out
                # — they're "no calificado" / "mal calificado", neither
                # of which is a 1-4 score.
                func.avg(
                    case(
                        (
